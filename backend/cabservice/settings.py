...
WSGI_APPLICATION = 'cabservice.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('DB_NAME', 'cabservice_db'),
        'USER': os.environ.get('DB_USER', 'cabservice_user'),
